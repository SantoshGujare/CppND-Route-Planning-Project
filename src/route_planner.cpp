...
/* Creating custom comparison function to compare and sort open node list
 *  comaparing g+h value. 
 * Refrence : https://www.cplusplus.com/reference/algorithm/sort/?kw=sort 
 */
